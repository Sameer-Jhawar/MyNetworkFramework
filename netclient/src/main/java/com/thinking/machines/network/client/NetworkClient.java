...
{
System.out.println("File : server.cfg not found");
System.exit(0);
}
try
{
...
{
System.out.println("Length of file : server.cfg is zero");
System.exit(0);
}
String j=randomAccessFile.readLine();
Gson gson=new Gson();
configuration=gson.fromJson(j,Conf.class);
